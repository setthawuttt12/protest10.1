<template>
    <v-container>
        <v-row justify="center">
            <v-col md="12" cols="12">
                <v-card class="pa-2">
                    <v-card-title><h1 class="text-h5 text-center">ผู้รับการประเมินผล</h1></v-card-title>
                            ...
                            <tbody>
                                <tr v-for="(items,index) in List" :key="items.id_commit">
                                    ...
                                    <td class="border text-center">
                                        <center>
                                            <v-btn class="text-center ma-2 text-white" color="error" size="small" @click="del(items.id_commit)">ลบ</v-btn>
                                        </center>
                                    </td>
                                </tr>
                            </tbody>
...
const del = async (id_commit:number) => {
    ...
    try {
        ...
        console.error("Error delete commmit",error);

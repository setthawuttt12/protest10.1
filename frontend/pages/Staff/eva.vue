                            ...
                            <tbody>
                                <tr v-for="(items,index) in result" :key="items.id_eva">
                                    ...
                                    <td class="border text-center">
                                        <center>
                                            <v-btn class="text-center ma-2 text-white" color="success" size="small" @click="go(items.id_eva)">เพิ่มกรรมการ</v-btn>
                                        </center>
                                    </td>
                                    <td class="border text-center">
                                        <center>
                                            <v-btn class="text-center ma-2 text-white" color="warning" size="small" @click="edit(items)">แก้ไข</v-btn>
                                            <v-btn class="text-center ma-2 text-white" color="error" size="small" @click="del(items.id_eva)">ลบ</v-btn>
                                        </center>
                                    </td>
                                </tr>
...
function validateForm(){
    ...
    if(!f.id_sys.trim())error.value.id_sys = 'กรุณากรอกรอบการประเมิน'
...
const go =(id_eva:number)=>{
    navigateTo({path:`/Staff/eva-commit-${id_eva}`})
}

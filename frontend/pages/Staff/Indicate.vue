                    ...
                    <v-card-text>
                        ...
                        <v-form @submit.prevent="saveMember">
                            ...
                            <v-row>
                                <v-col cols="12" md="12">
                                    <center>
                                        <v-btn class="text-center ma-2 " color="primary" type="submit">{{ form.id_indicate ? 'อัปเดต':'บันทึก' }}</v-btn>
                                ...
                                <tr v-for="(items,index) in result" :key="items.id_indicate">
                                    ...
                                    <td class="border text-center">
                                        <center>
                                            ...
                                            <v-btn class="text-center ma-2 text-white" color="error" size="small" @click="del(items.id_indicate)">ลบ</v-btn>
                                        </center>
                                    </td>
                                </tr>

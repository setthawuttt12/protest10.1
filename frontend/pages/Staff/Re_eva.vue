    ...
    <v-container>
        <v-row justify="center">
            <v-col md="12" cols="12">
                <v-card class="pa-2">
                    <v-card-title>
                        <h1 class="text-h5 text-center">รายงานผู้รับการประเมินผล</h1>
                    </v-card-title>
                    <v-card-text>
                ...
                <center><v-btn class="no-p mt-3" color="warning" prepend-icon="mdi-printer" @click="print()">พิมพ์</v-btn></center>
            </v-col>
        </v-row>
    </v-container>
</template>
...
const fetch = async()=>{
    try {
        ...
        console.error("error fetch showE",error);
